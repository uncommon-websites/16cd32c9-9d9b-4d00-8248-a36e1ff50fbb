<nav class="flex items-center justify-between px-6 py-4 bg-[#f5f5f5] text-sm font-medium border-b border-transparent">
  <div class="flex items-center gap-8">
    <div class="flex items-center gap-3">
      ...
      <div class="font-bold text-lg tracking-wide">KVANTS</div>
      <span class="text-gray-500 ml-2">AI Quantitative Trading</span>
    </div>
  </div>

  <div class="hidden md:flex items-center gap-8 absolute left-1/2 -translate-x-1/2">
    <a href="#vaults" class="text-gray-900 hover:text-gray-600">Vaults</a>
    <a href="#strategies" class="text-gray-500 hover:text-gray-900">Strategies</a>
    <a href="#token" class="text-gray-500 hover:text-gray-900">$KVAI Token</a>
  </div>

  <div class="flex items-center gap-6">
    <a href="/" class="text-gray-900 hover:text-gray-600">Log in</a>
    <a href="/" class="bg-black text-white px-5 py-2 rounded text-xs font-medium hover:bg-gray-800 transition-colors">Launch App</a>
  </div>
</nav>
