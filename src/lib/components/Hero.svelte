<section class="bg-[#f5f5f5] px-6 pt-16 pb-0">
  <div class="max-w-[1400px] mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
      <div class="lg:col-span-7">
        <h1 class="font-serif text-5xl md:text-6xl lg:text-[64px] leading-[1.1] tracking-tight text-gray-900">
          Institutional trading returns via AI-powered strategies
        </h1>
      </div>
      <div class="lg:col-span-5 flex flex-col justify-between">
        <p class="text-gray-500 text-lg max-w-md leading-relaxed">
          Access quantitative trading strategies previously reserved for hedge funds. Starting at $500, powered by AI, secured by dual audits.
        </p>
      </div>
    </div>
    ...
    <div class="relative w-full h-[600px] overflow-hidden rounded-sm bg-gray-900">
      <!-- Image Overlay -->
      <img 
        src="https://images.unsplash.com/photo-1642790106117-e829e14a795f?q=80&w=2940&auto=format&fit=crop" 
        alt="Abstract data visualization" 
        class="absolute inset-0 w-full h-full object-cover opacity-30 mix-blend-overlay"
      />
      <div class="absolute inset-0 bg-gradient-to-tr from-gray-950/95 to-primary-950/50 mix-blend-multiply"></div>
